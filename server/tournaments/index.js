	...
	onTournamentEnd() {
		...
		if (tourSize >= sizeRequiredToEarn) {
			...
			if (runnerUp) {
				...
				this.room.add("|raw|<b><font color='" + COLOR + "'>" + Chat.escapeHTML(runnerUp) + "</font> has won " + "<font color='" + COLOR + "'>" + secondMoney + "</font>" + currencyName(secondMoney) + " for winning the tournament!</b>");
			}
		}
		// Boilerplate end
