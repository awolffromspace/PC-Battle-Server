	...
	BattleRoom.prototype.win = function (winner) {
		...
		if (this.rated) {
			...
			if (!rated.p1 || !rated.p2) {
				...
				if (this.format === 'lotw7winterwonderland') {
					let wid = toId(winner);
		...
		if (p1.latestIp !== p2.latestIp) {
			...
			if (this.format === 'customgame' || this.format === 'doublescustomgame' || this.format === 'triplescustomgame' || this.format === 'gen5customgame' || this.format === 'gen5doublescustomgame' || this.format === 'gen4customgame' || this.format === 'gen4doublescustomgame' || this.format === 'gen3customgame' || this.format === 'gen2customgame' || this.format === 'gen1customgame') return false;
			if (this.format === '1v1random' || this.format === '1v1challengecup' || this.format === '1v1') {
				let wid = toId(winner);
