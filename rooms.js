...
class BattleRoom extends Room {
	...
	win(winner) {
		...
		if (this.rated) {
			...
			if (this.format === 'lotw32inverserandom') {
			...
			} else if (this.format !== 'gen71v1random' && this.format !== 'gen71v1challengecup' && this.format !== 'gen71v1' && this.format !== 'gen7battlespotspecial4') {
