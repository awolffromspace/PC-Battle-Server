...
class RandomTeams {
	...
	randomTeam() {
		...
		// For Monotype
		let isMonotype = this.format.id === 'gen8monotyperandom';
		...
		for (const restrict of [true, false]) {
			...
			while (pokemonPool.length && pokemon.length < 6) {
				...
				case 'Basculin': case 'Cherrim': case 'Floette': case 'Giratina': case 'Hoopa': case 'Landorus': case 'Meloetta': case 'Meowstic': case 'Shaymin': case 'Thundurus': case 'Tornadus':
					...
					break;
				case 'Dugtrio': case 'Diglett': case 'Exeggutor': case 'Golem': case 'Graveler': case 'Geodude': case 'Greninja': case 'Marowak': case 'Muk': case 'Grimer': case 'Ninetales': case 'Vulpix':
